function [kappa,tcf] = FourPtTCF_cyclic3state_norm(tau1range,tau2,A0,A1,A2,k01,k10,k12,k21,k20)
...
c2 = 0.5*sqrt(k01^2 + 2*k01*k02 + 2*k01*k10 - 2*k01*k12 - 2*k01*k20 - 2*k01*k21 + k02^2 - 2*k02*k10 - 2*k02*k12 + 2*k02*k20 - 2*k02*k21 + k10^2 + 2*k10*k12 - 2*k10*k20 - 2*k10*k21 + k12^2 - 2*k12*k20 + 2*k12*k21 + k20^2 + 2*k20*k21 + k21^2);
lam1 = c1 + c2;
lam2 = c1 - c2;
