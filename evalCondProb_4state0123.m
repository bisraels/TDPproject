...
load('sym_prob.mat') 
% This gives equilibruim probabilties: P0_Cn4, P1_Cn4, P2_Cn4, P3_Cn4

% This is a vector for the FRET values - assign values
A = [A0, A1, A2, A3];
% Matrix of conditional probabilities (Pi-->j, with i = initial condition)
cP = [P00(t), P01(t), P02(t), P03(t);...
      P10(t), P11(t), P12(t), P13(t);...
      P20(t), P21(t), P22(t), P23(t);...
      P30(t), P31(t), P32(t), P33(t)];

Peq = [P0_Cn4;  P1_Cn4; P2_Cn4; P3_Cn4];


C2 = A(j) * cP(j,i) * A(i) * Peq(i);
