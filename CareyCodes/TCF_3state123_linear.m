function tcf = TCF_3state123_linear(time,A1,A2,A3,k12,k21,k23,k32)
...
% Calculate TCF
tcf = p3_eq*A3*(A3*p3_3 + A2*p2_3 + A1*p1_3) + p2_eq*A2*(A3*p3_2 + A2*p2_2 + A1*p1_2) + p1_eq*A1*(A3*p3_1 + A2*p2_1 + A1*p1_3);